...
from transformers.models.t5.modeling_t5 import T5PreTrainedModel, T5Config, logger, T5Stack
...
class T5ForLabelGeneration(T5PreTrainedModel):
    def __init__(self, config: T5Config, my_config):
        super().__init__(config)
        self.my_config = my_config
        self.padding_idx = my_config['padding_idx']
        ...
        self.label_emb = nn.Embedding(self.my_config['label_size'], config.d_model,
                                      padding_idx=self.my_config['padding_idx'])
        decoder_config = copy.deepcopy(config)
        decoder_config.is_decoder = True
        decoder_config.is_encoder_decoder = False
        decoder_config.num_layers = config.num_decoder_layers
        self.decoder = T5Stack(decoder_config, self.label_emb)
